...
<FIXME>
    ...
    while i<len(arglist):
        ...
        call_params = {}
        call_pos_params = []
        chain_link['pos_params'] = call_pos_params
...
if __name__ == '__main__':
    ...
    #
    cmd_line = 'clip labA: method_A posA1 --p5- -p6=60 --p7= -p6=600 --p8.key1=v81 --p8.key2=82 , labB: method_B ,, method_C --p9.alpha.beta=999 -p9.alpha.gamma=boo -p10 --data.empty1 --data.empty2= --data.empty3,= --data.empty4,'
